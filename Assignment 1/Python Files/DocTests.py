...
>>> pie = ChartController()
>>> pie.get_pie_chart('This is a pie chart', ['one', 'two'], [1, 2])
Pie Chart Made!
True

>>> bar = ChartController()
>>> bar.get_bar_graph('This is a bar graph', ['one', 'two'], [1, 2], ['chart name 1', 'chart name 2'])
Bar Graph Made!
True

>>> box = ChartController()
>>> box.get_box_plot('This is a box chart', [4500, 2500, 1200], [500, 6000, 2400], ['chart one', 'chart 2'])
Box Plot Made!
True

>>> scatter = ChartController()
>>> scatter.get_scatter_graph('This is a scatter graph', ['Oxygen', 'Hydrogen'], [4500, 2500, 1053, 500], [500, 2400, 1453, 5700])
Scatter Graph Made!
True
...
>>> file.get_file()
[['Oxygen', 'Hydrogen', 'Carbon_Dioxide'], ['4500', '2500', '1053'], ['Word Names', 'Number Names', 'None']]
"""
